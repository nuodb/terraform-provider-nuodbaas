...
// Valid indicates whether the value is a known member of the BackupStatusModelState enum.
func (e BackupStatusModelState) Valid() bool {
	switch e {
	case BackupStatusModelStateDeleting:
		return true
	case BackupStatusModelStateFailed:
		return true
	case BackupStatusModelStatePending:
		return true
	case BackupStatusModelStateSucceeded:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the BackupStatusModelRetainedAs enum.
func (e BackupStatusModelRetainedAs) Valid() bool {
	switch e {
	case BackupStatusModelRetainedAsDaily:
		return true
	case BackupStatusModelRetainedAsHourly:
		return true
	case BackupStatusModelRetainedAsMonthly:
		return true
	case BackupStatusModelRetainedAsWeekly:
		return true
	case BackupStatusModelRetainedAsYearly:
		return true
	default:
		return false
	}
...
const (
	...
	DatabaseStatusModelStateUpgrading            DatabaseStatusModelState = "Upgrading"
)

// Valid indicates whether the value is a known member of the DatabaseStatusModelState enum.
func (e DatabaseStatusModelState) Valid() bool {
	switch e {
	case DatabaseStatusModelStateAvailable:
		return true
	case DatabaseStatusModelStateCreating:
		return true
	case DatabaseStatusModelStateDeleting:
		return true
	case DatabaseStatusModelStateExpired:
		return true
	case DatabaseStatusModelStateFailed:
		return true
	case DatabaseStatusModelStateModifying:
		return true
	case DatabaseStatusModelStateRestoring:
		return true
	case DatabaseStatusModelStateRotatingCertificates:
		return true
	case DatabaseStatusModelStateStopped:
		return true
	case DatabaseStatusModelStateStopping:
		return true
	case DatabaseStatusModelStateUpgrading:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the ErrorContentCode enum.
func (e ErrorContentCode) Valid() bool {
	switch e {
	case ErrorContentCodeCONCURRENTUPDATE:
		return true
	case ErrorContentCodeHTTPERROR:
		return true
	case ErrorContentCodeUNKNOWNREQUEST:
		return true
	default:
		return false
	}
...
func (e JsonPatchOperationOp) Valid() bool {
	...
	case JsonPatchOperationOpAdd:
		return true
	case JsonPatchOperationOpCopy:
		return true
	case JsonPatchOperationOpMove:
		return true
	case JsonPatchOperationOpRemove:
		return true
	case JsonPatchOperationOpReplace:
		return true
	case JsonPatchOperationOpTest:
		return true
	default:
		return false
	}
...
const (
	...
	ProjectStatusModelStateUpgrading            ProjectStatusModelState = "Upgrading"
)

// Valid indicates whether the value is a known member of the ProjectStatusModelState enum.
func (e ProjectStatusModelState) Valid() bool {
	switch e {
	case ProjectStatusModelStateAvailable:
		return true
	case ProjectStatusModelStateCreating:
		return true
	case ProjectStatusModelStateDeleting:
		return true
	case ProjectStatusModelStateExpired:
		return true
	case ProjectStatusModelStateFailed:
		return true
	case ProjectStatusModelStateModifying:
		return true
	case ProjectStatusModelStateRotatingCertificates:
		return true
	case ProjectStatusModelStateStopped:
		return true
	case ProjectStatusModelStateStopping:
		return true
	case ProjectStatusModelStateUpgrading:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the RotationSettingsModelDayOfWeek enum.
func (e RotationSettingsModelDayOfWeek) Valid() bool {
	switch e {
	case RotationSettingsModelDayOfWeekFriday:
		return true
	case RotationSettingsModelDayOfWeekMonday:
		return true
	case RotationSettingsModelDayOfWeekSaturday:
		return true
	case RotationSettingsModelDayOfWeekSunday:
		return true
	case RotationSettingsModelDayOfWeekThursday:
		return true
	case RotationSettingsModelDayOfWeekTuesday:
		return true
	case RotationSettingsModelDayOfWeekWednesday:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the RotationSettingsModelMonth enum.
func (e RotationSettingsModelMonth) Valid() bool {
	switch e {
	case RotationSettingsModelMonthApril:
		return true
	case RotationSettingsModelMonthAugust:
		return true
	case RotationSettingsModelMonthDecember:
		return true
	case RotationSettingsModelMonthFebruary:
		return true
	case RotationSettingsModelMonthJanuary:
		return true
	case RotationSettingsModelMonthJuly:
		return true
	case RotationSettingsModelMonthJune:
		return true
	case RotationSettingsModelMonthMarch:
		return true
	case RotationSettingsModelMonthMay:
		return true
	case RotationSettingsModelMonthNovember:
		return true
	case RotationSettingsModelMonthOctober:
		return true
	case RotationSettingsModelMonthSeptember:
		return true
	default:
		return false
	}
...
// ArchiveDiskAutoResizeModel Resize the archive volumes automatically when a threshold is reached.
type ArchiveDiskAutoResizeModel struct {
	// InitialSize The initial volume size.
	InitialSize *string `cty:"initial_size" hcl:"initial_size" json:"initialSize,omitempty" tfsdk:"initial_size"`

	// MaxSize The maximum volume size.
	MaxSize *string `cty:"max_size" hcl:"max_size" json:"maxSize,omitempty" tfsdk:"max_size"`

	// Growth Determines the new size of the volume. By default the volume size will be increased by 20% (or minimum of 1Gi). If maxSize is set, then the new volume size will be evaluated as the minimum of maxSize and result of applying the growth configuration.
	Growth *DiskResizeGrowth `cty:"growth" hcl:"growth" json:"growth,omitempty" tfsdk:"growth"`

	// Threshold The threshold at which the volume will be expanded.
	Threshold DiskResizeThreshold `cty:"threshold" hcl:"threshold" json:"threshold" tfsdk:"threshold"`
}
...
type BackupPolicyStatusModel struct {
	// CreationTime The time that the backup policy was created
...
type BackupStatusModel struct {
	// RequestedTime The time that the backup was requested
	RequestedTime *string `cty:"requested_time" hcl:"requested_time" json:"requestedTime,omitempty" tfsdk:"requested_time"`
...
type DatabasePropertiesModel struct {
	...
	// ArchiveDiskAutoResize Resize the archive volumes automatically when a threshold is reached.
	ArchiveDiskAutoResize *ArchiveDiskAutoResizeModel `cty:"archive_disk_auto_resize" hcl:"archive_disk_auto_resize" json:"archiveDiskAutoResize,omitempty" tfsdk:"archive_disk_auto_resize"`
...
type DatabaseStatusModel struct {
	// CreationTime The time that the database was created
	CreationTime *string `cty:"creation_time" hcl:"creation_time" json:"creationTime,omitempty" tfsdk:"creation_time"`

	// LastStateTransitionTime The time that the last state transition occurred
	LastStateTransitionTime *string `cty:"last_state_transition_time" hcl:"last_state_transition_time" json:"lastStateTransitionTime,omitempty" tfsdk:"last_state_transition_time"`
...
// DiskResizeGrowth Determines the new size of the volume. By default the volume size will be increased by 20% (or minimum of 1Gi). If maxSize is set, then the new volume size will be evaluated as the minimum of maxSize and result of applying the growth configuration.
type DiskResizeGrowth struct {
	// Increment Increase the volume size by a constant number of bytes. Minimum accepted increment is 1Gi.
	Increment *string `cty:"increment" hcl:"increment" json:"increment,omitempty" tfsdk:"increment"`

	// Scale Increase the volume size by a factor of the current size.
	Scale *string `cty:"scale" hcl:"scale" json:"scale,omitempty" tfsdk:"scale"`
}

// DiskResizeThreshold The threshold at which the volume will be expanded.
type DiskResizeThreshold struct {
	// BytesAvailable Threshold in number of available bytes at which volume expansion is performed.
	BytesAvailable *string `cty:"bytes_available" hcl:"bytes_available" json:"bytesAvailable,omitempty" tfsdk:"bytes_available"`

	// PercentageAvailable Threshold in percentage of available disk space at which volume expansion is performed.
	PercentageAvailable *int32 `cty:"percentage_available" hcl:"percentage_available" json:"percentageAvailable,omitempty" tfsdk:"percentage_available"`
}
...
// JournalDiskAutoResizeModel Resize the journal volumes automatically when a threshold is reached.
type JournalDiskAutoResizeModel struct {
	// InitialSize The initial volume size.
	InitialSize *string `cty:"initial_size" hcl:"initial_size" json:"initialSize,omitempty" tfsdk:"initial_size"`
...
type ProjectStatusModel struct {
	// CreationTime The time that the project was created
	CreationTime *string `cty:"creation_time" hcl:"creation_time" json:"creationTime,omitempty" tfsdk:"creation_time"`
...
type GetAllBackupPoliciesParams struct {
	...
	// SortBy Comma-separated list of field paths used to extract values to sort by lexicographically. The query parameter can be specified multiple times.
	SortBy *[]string `form:"sortBy,omitempty" json:"sortBy,omitempty"`

	// Reverse Whether to list resources in reverse order
	Reverse *bool `form:"reverse,omitempty" json:"reverse,omitempty"`

	// FieldFilter Comma-separated list of filters to apply based on fields, which are composed using `AND`. The query parameter can be specified multiple times. Acceptable filter expressions are:
	...
	// * `fieldPath~value` - Only return resources that have a value at the specified field path matching the regular expression
	// * `fieldPath>=value` - Only return resources that have a value at the specified field path lexicographically greater than or equal to the value
	// * `fieldPath<=value` - Only return resources that have a value at the specified field path lexicographically less than or equal to the value
